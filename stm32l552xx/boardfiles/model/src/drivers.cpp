...
void initDrivers()
{
    ...
    leftFlapMotorHandle = new (&leftFlapMotorStorage) MotorControl(&htim3, TIM_CHANNEL_1, 5, 10);
    rightFlapMotorHandle = new (&rightFlapMotorStorage) MotorControl(&htim3, TIM_CHANNEL_2, 5, 10);
    steeringMotorHandle = new (&steeringMotorStorage) MotorControl(&htim3, TIM_CHANNEL_3, 5, 10);
