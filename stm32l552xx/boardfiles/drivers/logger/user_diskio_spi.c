...
#include "stm32l5xx_hal.h" /* Provide the low-level HAL functions */
#include "utils.h"

#ifdef SPI_INTERFACE

//Make sure you set #define SD_HANDLE as some hspix in main.h
...
)
{
	...
	if (osKernelGetState() == osKernelRunning) {
	  HAL_SPI_TransmitReceive_DMA(&hspi1, &dat, &rxDat, 1);
	  ...
	  HAL_SPI_TransmitReceive(&hspi1, &dat, &rxDat, 1, HAL_MAX_DELAY);
	  spiTxFlag = 1;
	}
