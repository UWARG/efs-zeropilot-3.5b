...
extern DSTATUS USER_SPI_initialize (BYTE drv);
extern DSTATUS USER_SPI_status (BYTE drv);
extern DRESULT USER_SPI_read (BYTE drv, BYTE *buff, DWORD sector, UINT count);
#if _USE_WRITE == 1
  extern DRESULT USER_SPI_write (BYTE drv, BYTE *buff, DWORD sector, UINT count);
#endif /* _USE_WRITE == 1 */
#if _USE_IOCTL == 1
  extern DRESULT USER_SPI_ioctl (BYTE drv, BYTE cmd, void *buff);
#endif /* _USE_IOCTL == 1 */
