...
static constexpr uint16_t CRSF_RANGE_MIN = 172; //represents 988us (microseconds)
static constexpr uint16_t CRSF_RANGE_MAX = 1811; //represents 2012us (microseconds)
static constexpr uint16_t CRSF_RANGE_RANGE = (CRSF_RANGE_MAX - CRSF_RANGE_MIN);
